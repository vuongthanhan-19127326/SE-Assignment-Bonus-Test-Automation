...
WebUI.click(findTestObject('Object Repository/Page_Course 3/div_Assignment                             _58c6e9'))

WebUI.click(findTestObject('Object Repository/Page_Course 3/i_Mark as done_icon fa fa-ellipsis-v fa-fw'))

WebUI.click(findTestObject('Object Repository/Page_Course 3/span_Delete'))

WebUI.click(findTestObject('Object Repository/Page_Course 3/button_Yes'))
